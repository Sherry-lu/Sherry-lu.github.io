...
const dragend_handler = ev => {
  ...
  const showModal = () => {
      document.getElementById("You won! All creatures are deserving of a life free from fear and pain - Maura Cummings");
...
const letters= ['All', "creatures", "deserving", "a", "life", "free", "from", "pain", ""]
function setUp() {
    fillGrid(ul, letters);
    setId(ul)
